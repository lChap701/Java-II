 ...
 * JUnit Tests for testing the CalcCostPerFill() of this program
 */
public class CarTestClass {
    ...
    public void testGasCar() {
        ...
        GasCar g2 = new GasCar("make", "model", 2021, "black", 2900, iTankSize,
                "Diesel");
    ...
    public void testElectricCar() {
        ...
        */
        ...
        e2 = new ElectricCar("tesla", "model 3", 2025, "white", 3010, iTankSize,
                "ion");
