...
public class CarProgram {
    ...
    /**
     * Prompts the user for if they want to get either a gas car and electric car
    ...
    /**
     * Calls other methods to gather enough information to create a GasCar object to be used to
    ...
    /**
     * Calls other methods to gather enough information to create ElectricCar objects to be used to
     * display formatted data back to the user
     */
