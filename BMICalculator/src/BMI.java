 ...
 * This program is a BMI calculator that is designed to calculate the user's BMI and display to the user what category
 * they are in based on their results. This is the instantiable class
 */
public class BMI {
    // instance variables
